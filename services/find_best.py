...
prompt_for_sort= """
Отсортируй текст, так чтобы самыми первыми были те что заканчиваются на лингвистических конструкции завершающие мысли, рассказ, итог и тд. , если оба текста хорошо заканчиваются выбирай между ними по самому интересному, интригующему.
